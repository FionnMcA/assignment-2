...
def random_genome(name):
    ...
    random_strat = Strategy(name=f"Random Strategy - {name}", first_move=first_move, responses=responses, memory_size=1,  hold_grudges=hold_grudges, random_defection=random_defection)
    return random_strat
